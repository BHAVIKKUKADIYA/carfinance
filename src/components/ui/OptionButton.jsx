...
export default function OptionButton({ label, selected, onClick, icon, rightIcon }) {
  const [clicked, setClicked] = useState(false);
  const IconToRender = rightIcon || ArrowRight;
  ...
  return (
    ...
    >
      ...
      {clicked ? (
        <svg className="option-btn-spinner" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="20" height="20" fill="white">
